...
// RED: a failing test
test("TDD explanation: map() should return an array with the same number of elements", t => {
  const result = map([1], () => {});
...
// RED: a failing test
test("TDD explanation: map() should transform a one element array using the fn argument", t => {
...
// RED: a failing test
test("TDD explanation: map() should transform a two element array using the fn argument", t => {
...
test("TDD explanation: map() should transform every item in an array using the fn argument", t => {
